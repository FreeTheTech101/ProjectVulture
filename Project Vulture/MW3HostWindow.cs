...
{
    public partial class MW3HostWindow : DevComponents.DotNetBar.Metro.MetroForm
    {
        public static Encoding Encoding = Encoding.UTF8;

        public MW3HostWindow()
        {
            InitializeComponent();
        }
        ...
        private void MW3HostWindow_Load(object sender, EventArgs e)
        {
            MP.Start();
            MapName.Start();
        }
        ...
        private void TakeIMS_Click(object sender, EventArgs e)
        {
            if (MapSide.Text == "Map Side A")
            {
                ...
                GivePrimaryWeapon(ClientID, "0");
                GiveSecondaryWeapon(ClientID, "0");
                GivePrimaryWeapon(ClientID, "27");
                GivePrimaryWeaponAmmo(ClientID, "27");
                PlayerSwitchToWeapon(ClientID, "27");
            }
            ...
            if (MapSide.Text == "Map Side B")
            {
                ...
                GivePrimaryWeapon(ClientID, "0");
                GiveSecondaryWeapon(ClientID, "0");
                GivePrimaryWeapon(ClientID, "28");
                GivePrimaryWeaponAmmo(ClientID, "28");
                PlayerSwitchToWeapon(ClientID, "28");
            }
        }
        ...
        {
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "26");
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "25");
                GiveSecondaryWeaponAmmo(ClientID, "25");
                GiveSecondaryWeaponAmmoLeft(ClientID, "25");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Red Dot Sight" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Red Dot Sight" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "12313");
                GiveSecondaryWeaponAmmo(ClientID, "12313");
                GiveSecondaryWeaponAmmoLeft(ClientID, "12313");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "ACOG Scope" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "ACOG Scope" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "4121");
                GiveSecondaryWeaponAmmo(ClientID, "4121");
                GiveSecondaryWeaponAmmoLeft(ClientID, "4121");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Holographic Sight" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Holographic Sight" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "8217");
                GiveSecondaryWeaponAmmo(ClientID, "8217");
                GiveSecondaryWeaponAmmoLeft(ClientID, "8217");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Hybrid Sight" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Hybrid Sight" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "98329");
                GiveSecondaryWeaponAmmo(ClientID, "98329");
                GiveSecondaryWeaponAmmoLeft(ClientID, "98329");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Thermal Scope" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Thermal Scope" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "16409");
                GiveSecondaryWeaponAmmo(ClientID, "16409");
                GiveSecondaryWeaponAmmoLeft(ClientID, "16409");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Grenade Launcher" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "65562");
                GiveSecondaryWeaponAmmo(ClientID, "65562");
                GiveSecondaryWeaponAmmoLeft(ClientID, "65562");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach2Ops.Text == "Grenade Launcher" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "65561");
                GiveSecondaryWeaponAmmo(ClientID, "65561");
                GiveSecondaryWeaponAmmoLeft(ClientID, "65561");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveSecondaryAmmoLeft(ClientID, "300");
            }
            ...
            #region M4A1 Map Side A
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Red Dot Sight" && Attach2Ops.Text == "Grenade Launcher" && MapSide.Text == "Map Side A")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "77848");
                GiveSecondaryWeaponAmmo(ClientID, "77848");
                GiveSecondaryWeaponAmmoLeft(ClientID, "77848");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveGrenade(ClientID, "2");
                GiveSecondaryAmmoLeft(ClientID, "300");
            ...
            #region M4A1 Map Side B
            if (WeaponOps.Text == "M4A1" && Attach1Ops.Text == "Red Dot Sight" && Attach2Ops.Text == "Grenade Launcher" && MapSide.Text == "Map Side B")
            {
                int ClientID = Convert.ToInt32(CustomWeaponID.Value);
                GiveSecondaryWeapon(ClientID, "77847");
                GiveSecondaryWeaponAmmo(ClientID, "77847");
                GiveSecondaryWeaponAmmoLeft(ClientID, "77847");
                GiveSecondaryAmmo(ClientID, "0");
                GiveSecondaryAkimbo(ClientID, "0");
                GiveGrenade(ClientID, "2");
                GiveSecondaryAmmoLeft(ClientID, "300");
